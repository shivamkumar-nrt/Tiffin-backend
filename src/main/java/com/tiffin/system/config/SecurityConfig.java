...
import com.tiffin.system.security.UserDetailsServiceImpl;
import com.tiffin.system.security.jwt.AuthEntryPointJwt;
import com.tiffin.system.security.jwt.AuthTokenFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/api/prices/current").permitAll()
                .requestMatchers("/api/invoices/*/pdf").permitAll()
